...
class OwnerAgreement extends Model
{
    ...
    {
        return $this->belongsToMany(Property::class, 'owner_agreement_properties')
            ->withPivot(['branch_id', 'owner_customer_id'])
            ->withTimestamps();
    }

    public function installments(): HasMany
    {
        return $this->hasMany(OwnerAgreementInstallment::class);
    }
