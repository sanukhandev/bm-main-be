...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'user.active', 'branch.context', 'throttle:api'])->group(function () {
        ...
        Route::post('/quotations/{quotation}/payments', [BillingController::class, 'addQuotationPayment']);
        Route::patch('/quotations/{quotation}/payments/{payment}/status', [BillingController::class, 'quotationPaymentStatus']);
        ...
        Route::post('/invoices/{invoice}/payments', [BillingController::class, 'addInvoicePayment']);
        Route::patch('/invoices/{invoice}/payments/{payment}/status', [BillingController::class, 'invoicePaymentStatus']);
        ...
        Route::post('/maintenance/work-orders/{workOrder}/payments', [MaintenanceController::class, 'storeWorkOrderPayment']);
